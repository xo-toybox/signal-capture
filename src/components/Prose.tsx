...
export default function Prose({ content }: { content: string }) {
  return (
    <div className="
      ...
      prose-table:text-sm
      prose-th:text-[#a0a0a0] prose-th:font-normal prose-th:border-white/5
      prose-td:text-[#e5e5e5] prose-td:border-white/5
      prose-li:text-[#e5e5e5] marker:prose-li:text-[#888888]
      prose-blockquote:border-l-2 prose-blockquote:border-white/10 prose-blockquote:pl-4 prose-blockquote:text-[#a0a0a0] prose-blockquote:italic prose-blockquote:not-italic
